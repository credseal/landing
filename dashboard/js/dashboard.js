/**
 * CredSeal Dashboard - Core JavaScript
...
(function() {
  ...
  const CONFIG = {
    ...
    toastDuration: 4000,
    storageKeys: {
      sidebarCollapsed: 'credseal_sidebar_collapsed',
      welcomeDismissed: 'credseal_welcome_dismissed',
      theme: 'credseal_theme'
    }
  };
    ...
    if ('serviceWorker' in navigator) {
      window.addEventListener('load', async () => {
        try {
          ...
          console.log('[CredSeal] Service Worker registered:', registration.scope);
          ...
          console.warn('[CredSeal] Service Worker registration failed:', error);
        }
      });
    }
  }
