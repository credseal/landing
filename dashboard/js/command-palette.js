...
(function() {
  ...
  const commands = [
    ...
    // Actions
    { id: 'action-new-credential', label: 'Create New Credential', category: 'Actions', icon: 'plus', action: () => { navigate('credentials.html'); setTimeout(() => window.CredSeal?.openModal?.('create-credential-modal'), 300); } },
    { id: 'action-new-agent', label: 'Register New Agent', category: 'Actions', icon: 'plus-circle', action: () => { navigate('agents.html'); setTimeout(() => window.CredSeal?.openModal?.('register-agent-modal'), 300); } },
    ...
    // Documentation
    { id: 'docs-sdk', label: 'SDK Documentation', category: 'Docs', icon: 'book-open', action: () => window.open('https://github.com/credseal/sdk#readme', '_blank') },
    { id: 'docs-api', label: 'API Reference', category: 'Docs', icon: 'code', action: () => window.open('https://github.com/credseal/sdk#api-reference', '_blank') },
    { id: 'docs-python', label: 'Python SDK Guide', category: 'Docs', icon: 'file-text', action: () => window.open('https://github.com/credseal/sdk#python', '_blank') },
    { id: 'docs-typescript', label: 'TypeScript SDK Guide', category: 'Docs', icon: 'file-text', action: () => window.open('https://github.com/credseal/sdk#typescript', '_blank') },
  ...
  function toggleTheme() {
    ...
    localStorage.setItem('credseal_theme', isLight ? 'light' : 'dark');
    window.CredSeal?.showToast?.(isLight ? 'Light theme enabled' : 'Dark theme enabled', 'info');
  }
