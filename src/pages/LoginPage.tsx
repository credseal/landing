...
export function LoginPage() {
  ...
  async function onSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!response.ok) throw new Error(result.error || result.message || "Invalid email or password");
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Log in to your IdentArk account to manage credentials and monitor your AI agents." />
      ...
      >
        <div className="login-container">
          <div className="login-header">
            <h1>Welcome back</h1>
            <p>Sign in to your IdentArk account</p>
          </div>
